...
public class SelectableBonusFragmentDirections {
  private SelectableBonusFragmentDirections() {
  }

  @NonNull
  public static ActionSelectableBonusFragmentToCartFragment actionSelectableBonusFragmentToCartFragment(
      @NonNull ProductModel[] products, @Nullable SelectableBonus[] selectedBonuses) {
    return new ActionSelectableBonusFragmentToCartFragment(products, selectedBonuses);
  }

  public static class ActionSelectableBonusFragmentToCartFragment implements NavDirections {
    private final HashMap arguments = new HashMap();

    @SuppressWarnings("unchecked")
    private ActionSelectableBonusFragmentToCartFragment(@NonNull ProductModel[] products,
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionSelectableBonusFragmentToCartFragment setProducts(
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionSelectableBonusFragmentToCartFragment setSelectedBonuses(
        @Nullable SelectableBonus[] selectedBonuses) {
      this.arguments.put("selectedBonuses", selectedBonuses);
      return this;
    }
    ...
    public int getActionId() {
      return R.id.action_selectableBonusFragment_to_cartFragment;
    }
    ...
    public boolean equals(Object object) {
      ...
      ActionSelectableBonusFragmentToCartFragment that = (ActionSelectableBonusFragmentToCartFragment) object;
    ...
    public String toString() {
      return "ActionSelectableBonusFragmentToCartFragment(actionId=" + getActionId() + "){"
