...
public final class ImageSliderItemviewBinding implements ViewBinding {
  @NonNull
  ...
  private ImageSliderItemviewBinding(@NonNull FrameLayout rootView,
  ...
  @NonNull
  public static ImageSliderItemviewBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ImageSliderItemviewBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.image_slider_itemview, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ImageSliderItemviewBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ImageSliderItemviewBinding((FrameLayout) rootView, flShadowContainer,
