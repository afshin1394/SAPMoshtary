...
public final class AdapterSheetMenuBinding implements ViewBinding {
  @NonNull
  ...
  private AdapterSheetMenuBinding(@NonNull LinearLayout rootView, @NonNull ImageView imgSheetMenu,
      @NonNull LinearLayout llAdapterSheetMenu, @NonNull LinearLayout rootSheetMain,
      @NonNull TextView textSheetMenu) {
  ...
  @NonNull
  public static AdapterSheetMenuBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static AdapterSheetMenuBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.adapter_sheet_menu, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static AdapterSheetMenuBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new AdapterSheetMenuBinding((LinearLayout) rootView, imgSheetMenu, llAdapterSheetMenu,
          rootSheetMain, textSheetMenu);
    }
