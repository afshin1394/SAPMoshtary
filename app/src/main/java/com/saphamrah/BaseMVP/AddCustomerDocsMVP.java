...
public interface AddCustomerDocsMVP
{
    ...
    interface RequiredViewOps
    {
        ...
        void onGetImageStatus(boolean savedNationalCard, boolean savedJavazeKasb, boolean savedDasteCheck,boolean savedEmza, boolean isOld);
    ...
    interface PresenterOps
    {
        ...
        void deleteEmzaImage(int ccMoshtaryPhoto);
    ...
    interface RequiredPresenterOps
    {
        ...
        void onSuccessSavedEmzaImage(/*byte[] dastehCheck*/);
    ...
    interface ModelOps
    {
        ...
        void saveEmzaImage(int ccMoshtary , byte[] emza);
        void getNationalCardImage(int ccMoshtary);
        void getJavazeKasbImage(int ccMoshtary);
        void getDasteCheckImage(int ccMoshtary);
        void getEmzaImage(int ccMoshtary);
