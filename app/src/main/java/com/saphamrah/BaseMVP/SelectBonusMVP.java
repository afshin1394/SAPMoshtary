...
public interface SelectBonusMVP
{
    ...
    interface RequiredViewOps
    {
        ...
        void onGetKalaForJayezeh(ArrayList<JayezehEntekhabiMojodiModel> jayezehEntekhabiMojodiModels);
        void onCalculateMablaghJayezeh(float mablaghJayezeh  , float mandeh);
    ...
    interface PresenterOps
    {
        ...
        void calculateMablaghJayezeh(ArrayList<JayezehEntekhabiMojodiModel> jayezehEntekhabiMojodiModels , String mablaghTakhfif);
