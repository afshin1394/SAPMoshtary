...
public class HttpDownloadSpeedTest extends Thread
{
    ...
    public HttpDownloadSpeedTest(Context context , String fileURL)
    {
    ...
    public void run()
    {
        ...
        for (String link : fileUrls)
        {
            ...
            catch (Exception exception)
            {
                ...
                logger.insertLogToDB(context, Constants.LOG_EXCEPTION(), exception.toString(), HttpDownloadSpeedTest.class.getSimpleName(), "", "run", "");
            }
