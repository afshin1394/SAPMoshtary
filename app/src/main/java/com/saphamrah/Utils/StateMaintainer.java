...
public class StateMaintainer
{
    ...
    public StateMaintainer(FragmentManager fragmentManager, String stateMaintainerTAG, Context context)
    {
    ...
    public boolean firstTimeIn()
    {
        ...
        catch (Exception exception)
        {
            ...
            logger.insertLogToDB(context, Constants.LOG_EXCEPTION(), exception.toString(), "StateMaintainer", context.getClass().getSimpleName(), "firstTimeIn", "");
            return false;
        }
    }
    /**
