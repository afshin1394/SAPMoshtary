...
public class DarkhastFaktorMoshtaryForoshandeModel
{
    ...
    public String getFullNameForoshande() {
        return fullNameForoshande;
    }

    public void setFullNameForoshande(String fullNameForoshande) {
        this.fullNameForoshande = fullNameForoshande;
    }
    ...
    {
        return ExtraProp_ShowFaktorMamorPakhsh;
    }

    public void setExtraProp_ShowFaktorMamorPakhsh(int extraProp_ShowFaktorMamorPakhsh)
    {
        ExtraProp_ShowFaktorMamorPakhsh = extraProp_ShowFaktorMamorPakhsh;
    }
    ...
    {
        return canEditDarkhast;
    }

    public void setCanEditDarkhast(boolean canEditDarkhast)
    {
        this.canEditDarkhast = canEditDarkhast;
    }

    public int getCountDarkhastFaktor()
    {
        return CountDarkhastFaktor;
    }

    public void setCountDarkhastFaktor(int countDarkhastFaktor)
    {
    ...
    public String toString()
    {
        return "DarkhastFaktorMoshtaryForoshandeModel{" +
                ...
                ", CodeMoshtary='" + CodeMoshtary + '\'' +
                ", fullNameForoshande='" + fullNameForoshande + '\'' +
                ", CodeNoeVosolAzMoshtary=" + CodeNoeVosolAzMoshtary +
                ", ExtraProp_ShowFaktorMamorPakhsh=" + ExtraProp_ShowFaktorMamorPakhsh +
                ", Sort=" + Sort +
