...
import com.saphamrah.customer.utils.mapModule.Responses.Valhalla.Location;
import com.saphamrah.customer.utils.mapModule.Responses.Valhalla.Maneuver;
import com.saphamrah.customer.utils.mapModule.Responses.Valhalla.OptimizedRouteResult;
import com.saphamrah.customer.utils.mapModule.Responses.Valhalla.SourceToTargetSuccessResult;
import com.saphamrah.customer.utils.mapModule.Responses.Valhalla.SourcesToTargetsFailedResult;
import com.saphamrah.customer.utils.mapModule.Responses.Valhalla.Trip;
...
public class OsmdroidService {

    Context context;
    String baseUrl;

    public OsmdroidService(Context context, String baseUrl) {
            ...
            call.enqueue(new Callback<Object>() {
                ...
                public void onResponse(Call<Object> call, Response<Object> response) {
                    try {
                        ...
                        retrofitResponse.onFailed(Constants.HTTP_ERROR,"error get Routing Data");
