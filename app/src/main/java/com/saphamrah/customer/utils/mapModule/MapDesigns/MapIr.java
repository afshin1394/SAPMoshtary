...
import com.saphamrah.customer.utils.mapModule.Interfaces.IMapCondition;
...
/** Adding a GeoJson source for the SymbolLayer icons.**/
        ...
        SymbolLayer symbolLayer = new SymbolLayer(mapObjectModel.getLayer_id(), mapObjectModel.getSource_id());
        symbolLayer.withProperties(iconAllowOverlap(true),
                iconImage(mapObjectModel.getImage_id()),
            ...
            map.addOnMapClickListener(new MapboxMap.OnMapClickListener() {
                ...
                public boolean onMapClick(@NonNull com.mapbox.mapboxsdk.geometry.LatLng point) {
                    ...
                    if (!features.isEmpty()) {
                        ...
                        iMapClickEvents.onOtherItemsClick(new GeoPoint(point.getLatitude(),point.getLongitude()));
                    }
                    return false;
                }
            });
