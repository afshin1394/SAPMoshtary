...
public class LogPPCDAO
{
        ...
        return new String[]
                {
                        ...
                        LogPPCModel.COLUMN_LineOfCode(),
                        LogPPCModel.COLUMN_StackTrace(),
    ...
    public boolean insert(LogPPCModel logppcModel)
    {
        ...
        try {
            ...
            exception.printStackTrace();
            Log.i("exceptionMessage", "insert: " + exception.getMessage());
            //PubFunc.Logger logger = new PubFunc().new Logger();
    ...
    public boolean insertGlobal(LogPPCModel logppcModel) {
        ContentValues contentValues = modelToContentValueGlobal(logppcModel);
        try {
            SQLiteDatabase db = dbHelper.getWritableDatabase();
            db.insert(LogPPCModel.TableName(), null, contentValues);
            db.close();
    ...
    private ContentValues modelToContentValueGlobal(LogPPCModel model) {
        ContentValues contentValues = new ContentValues();
        ...
        contentValues.put(LogPPCModel.COLUMN_ExtraProp_IsOld(), model.getExtraProp_IsOld());
        contentValues.put(LogPPCModel.COLUMN_AndroidAPI(), model.getAndroidAPI());
        contentValues.put(LogPPCModel.COLUMN_LineOfCode(), model.getLineOfCode());
        contentValues.put(LogPPCModel.COLUMN_StackTrace(), model.getStackTrace());
