...
import com.saphamrah.protos.ReasonNonRequestGrpc;
import com.saphamrah.protos.ReasonNonRequestReply;
import com.saphamrah.protos.ReasonNonRequestReplyList;
import com.saphamrah.protos.ReasonNonRequestRequest;
    ...
    public void fetchElatAdamDarkhastGrpc(final Context context, final String activityNameForLog, final RetrofitResponse retrofitResponse)
    {
        try {
            ...
            if (serverIpModel.getServerIp().trim().equals("") || serverIpModel.getPort().trim().equals(""))
            {
                ...
                ReasonNonRequestRequest reasonNonRequestRequest = ReasonNonRequestRequest.newBuilder().build();
                Callable<ReasonNonRequestReplyList> getReasonNonRequestCallable  = () -> reasonNonRequestBlockingStub.getReasonNonRequest(reasonNonRequestRequest);
                RxAsync.makeObservable(getReasonNonRequestCallable)
                        ...
                        .map(reasonNonRequestReplyList -> {
                            ...
                            for (ReasonNonRequestReply reasonNonRequestReply : reasonNonRequestReplyList.getReasonNonRequestsList()) {
