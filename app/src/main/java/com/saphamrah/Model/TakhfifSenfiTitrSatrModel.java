...
/**
 * از تیتر همه فیلد ها وجود دارد
 * از سطر فیلد نوع وجود دارد
 */
public class TakhfifSenfiTitrSatrModel
{
    ...
    public void setSharhTakhfif(String SharhTakhfif){
        this.SharhTakhfif = SharhTakhfif;
    }
    ...
    {
        return "TakhfifSenfiTitrSatrModel{" +
                "Radif=" + Radif +
