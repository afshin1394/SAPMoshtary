...
public class MablaghForoshFragmentModel implements MablaghTedadForoshFragmentsBaseMVP.ModelOps {
    private MablaghTedadForoshFragmentsBaseMVP.RequiredPresenterOps mPresenter;

    public MablaghForoshFragmentModel(MablaghTedadForoshFragmentsBaseMVP.RequiredPresenterOps mPresenter) {
