...
//        mPresenter.onGetInfo(ccDarkhastFaktor , modatVosol , childParameterModelsVosols);
    ...
    public void getRequestsList()
    {
        ...
        if (ccDarkhastFaktor != 0)
        {
            ...
            ArrayList<KalaDarkhastFaktorSatrModel> kalaDarkhastFaktorSatrModels= null;
            if(canEditDarkhastForMovaze==1) {
                Log.d("Check1 verify","if canEditDarkhastForMovaze:" + canEditDarkhastForMovaze);
                kalaDarkhastFaktorSatrModels = kalaDarkhastFaktorDAO.getByccDarkhast(ccDarkhastFaktor);
            }
            else {
...
//            ArrayList<DarkhastFaktorJayezehModel> darkhastFaktorJayezehModels = darkhastFaktorJayezehDAO.getByccDarkhastFaktorAndCodeNoe(ccDarkhastFaktor, DarkhastFaktorJayezehModel.CodeNoeJayezehAuto());
            //todo Jayezeh
            ArrayList<DarkhastFaktorJayezehModel> darkhastFaktorJayezehModels = darkhastFaktorJayezehDAO.getByccDarkhastFaktorAndCodeNoe(ccDarkhastFaktor, DarkhastFaktorJayezehModel.CodeNoeJayezehAuto());
            ArrayList<DarkhastFaktorJayezehModel> darkhastFaktorJayezehModelsForHaveBonus = darkhastFaktorJayezehDAO.getByccDarkhastFaktorAndCodeNoeForHaveBonus(ccDarkhastFaktor, DarkhastFaktorJayezehModel.CodeNoeJayezehAuto());
            ...
            Log.d("verifyRequest" , "jayezeh haveBonus countJayezehInDarkhastFaktorJayzeh:" + countJayezehInDarkhastFaktorJayzeh + " countccTakhfifJayezeh: " + countccTakhfifJayezeh);
            Log.d("verifyRequest" , "jayezeh haveBonus countdarkhastFaktorJayezehModels:" + darkhastFaktorJayezehModels.size() );
            Log.d("verifyRequest" , "jayezeh haveBonus ccTakhfifJayezeh:" + selectFaktorShared.getString(selectFaktorShared.getCcTakhfifJayezes() , "").replace("," , "") );
            ...
            if (darkhastFaktorJayezehModelsForHaveBonus.size() > 0)
            {
                Log.d("jayezeh" , "checkForInsertJayezeh haveBonus true " + darkhastFaktorJayezehModelsForHaveBonus.size());

                haveBonus = true;
            }
            Log.d("jayezeh" , "checkForInsertJayezeh haveBonus true " + "haveBonus:" + haveBonus + "- showAddBonusBtn:" +  showAddBonusBtn);
    ...
    public void deleteTakhfifJayezeForDarkhastFaktor(long ccDarkhastFaktor)
    {
        ...
        darkhastFaktorSatrDAO.updateMablaghTakhfifNaghdiByccDarkhastFaktorSatr(ccDarkhastFaktorSatrs);
    ...
    @Override
    public void getDiscountArzeshAfzodeh(long sumMablaghKol, double sumMablaghBaArzeshAfzoodeh, int sumTedadAghlam, int tedadAghlam, double sumHajm, double sumVazn, double vaznFaktor, double hajmFaktor, double sumMablaghKhales, int sumTedadAghlamPishnehadiBiSetareh) {
...
//                                              mablaghTakhfif= sumMablaghKolGorohKala * (zarib* takhfifHajmiSatr.getDarsadTakhfif()/ 100);
        ...
        private void calculateJayezehs(DarkhastFaktorModel darkhastFaktor, ArrayList<ParameterChildModel> parameterChildModels)
        {
            ...
            try
            {
                ...
                for (DarkhastFaktorSatrModel darkhastFaktorSatr : darkhastFaktorSatrs)
                {
                    ...
                    for (JayezehModel jayezeh : jayezehs)
                    {
                        ...
                        for (JayezehSatrModel jayezehSatr : jayezehSatrs)
                        {
                            ...
                            if (tedadJayezeh!= 0)
                            {
                                Log.d("jayezeh" , "checkForInsertJayezeh Kala");
                                checkForInsertJayezeh(darkhastFaktor.getCcDarkhastFaktor(), darkhastFaktor.getCcForoshandeh(), jayezeh.getCcJayezeh(), jayezehSatr.getCcJayezehSatr(), jayezeh.getSharhJayezeh(), jayezehSatr.getCcKalaCodeJayezeh(), jayezehSatr.getCcKalaCodeJayezeh(), tedadJayezeh, jayezeh.getIsJayezehEntekhabi());
                            }
                ...
                for (JayezehModel jayezeh: jayezehs)
                {
                    ...
                    {
                        sumTedadGorohKala= Double.parseDouble(gorohKala.getFiled2());
                        sumTedadBastehGorohKala = Double.parseDouble(gorohKala.getFiled4());
                        sumTedadKartonGorohKala = Double.parseDouble(gorohKala.getFiled3());
                        sumMablaghKolGorohKala = Double.parseDouble(gorohKala.getFiled5());
                        ...
                        ArrayList<JayezehSatrModel> jayezehSatrs = jayezehSatrDAO.getForFaktor(jayezeh.getCcJayezeh(), 
								...
								new int[]{discountCalculation.getBasteBandiCarton(), discountCalculation.getBasteBandiBaste(), discountCalculation.getBasteBandiAdad()},
								gorohKala.getFiled1(), sumTedadGorohKala, sumTedadBastehGorohKala, sumTedadKartonGorohKala,  sumMablaghKolGorohKala, jayezeh.getNoeTedadRial(),tedadAghlam);
                        ...
                        for (JayezehSatrModel jayezehSatr: jayezehSatrs)
                        {
                            ...
                            if (zarib != 0)
                            {
                                if (jayezehSatr.getTedadJayezeh() != 0)
                                {
                                    Log.d("jayezeh" , "ccKalaCode of jayezeh Satr : " + jayezehSatr.getCcKalaCodeJayezeh());
                            ...
                            if (tedadJayezeh != 0)
                            {
                                Log.d("jayezeh" , "checkForInsertJayezeh Goroh Kala");
                                checkForInsertJayezeh(darkhastFaktor.getCcDarkhastFaktor(), darkhastFaktor.getCcForoshandeh(), jayezeh.getCcJayezeh(), jayezehSatr.getCcJayezehSatr(), jayezeh.getSharhJayezeh(), jayezehSatr.getCcKalaJayezeh(), jayezehSatr.getCcKalaCodeJayezeh(), tedadJayezeh, jayezeh.getIsJayezehEntekhabi());
                            }
                        }
                    }
                }
                ...
                for (JayezehModel jayezeh: jayezehs)
                {
                    ...
                    for (DataTableModel brand : brands)
                    {
                        ...
                        Log.d("jayezeh" , "tedadAghlam : " + tedadAghlamBrand);
                        ...
                        ArrayList<JayezehSatrModel> jayezehSatrs = jayezehSatrDAO.getForFaktor(jayezeh.getCcJayezeh(),
                                ...
                                new int[]{discountCalculation.getBasteBandiCarton(), discountCalculation.getBasteBandiBaste(), discountCalculation.getBasteBandiAdad()},
                                brand.getFiled1(), sumTedadBrand, sumTedadKartonBrand, sumTedadBastehBrand, sumMablaghKolBrand, jayezeh.getNoeTedadRial(),tedadAghlamBrand);
                        ...
                        for (JayezehSatrModel jayezehSatr: jayezehSatrs)
                        {
                            ...
                            if (tedadJayezeh != 0)
                            {
                                Log.d("jayezeh" , "checkForInsertJayezeh Brand");
                                checkForInsertJayezeh(darkhastFaktor.getCcDarkhastFaktor(), darkhastFaktor.getCcForoshandeh(), jayezeh.getCcJayezeh(), jayezehSatr.getCcJayezehSatr(), jayezeh.getSharhJayezeh(), jayezehSatr.getCcKalaJayezeh(), jayezehSatr.getCcKalaCodeJayezeh(), tedadJayezeh, jayezeh.getIsJayezehEntekhabi());
                            }
                        }
                    }
                ...
                for (JayezehModel jayezeh: jayezehs)
                {
                    ...
                    for (DataTableModel taminKonandeh : taminKonandehs)
                    {
                        ...
                        Log.d("jayezeh" , "tedadAghlamTaminKonandeh : " + tedadAghlamTaminKonandeh);
                        ...
                        ArrayList<JayezehSatrModel> jayezehSatrs = jayezehSatrDAO.getForFaktor(jayezeh.getCcJayezeh(),
                                ...
                                new int[]{discountCalculation.getBasteBandiCarton(), discountCalculation.getBasteBandiBaste(), discountCalculation.getBasteBandiAdad()},
                                taminKonandeh.getFiled1(), sumTedadTaminKonandeh, sumTedadKartonTaminKonandeh, sumTedadBastehTaminKonandeh, sumMablaghKolTaminKonandeh, jayezeh.getNoeTedadRial(),tedadAghlamTaminKonandeh);
                        ...
                        for (JayezehSatrModel jayezehSatr: jayezehSatrs)
                        {
                            ...
                            if (tedadJayezeh != 0)
                            {
                                Log.d("jayezeh" , "checkForInsertJayezeh TaminKonandeh");
                                checkForInsertJayezeh(darkhastFaktor.getCcDarkhastFaktor(),darkhastFaktor.getCcForoshandeh(), jayezeh.getCcJayezeh(), jayezehSatr.getCcJayezehSatr(), jayezeh.getSharhJayezeh(), jayezehSatr.getCcKalaJayezeh(), jayezehSatr.getCcKalaCodeJayezeh(), tedadJayezeh, jayezeh.getIsJayezehEntekhabi());
                            }
                        }
                    }
        ...
        private void checkForInsertJayezeh(long ccDarkhastFaktor, int ccForoshandeh, int ccJayezeh, int ccJayezehSatr, String sharhJayezeh, int ccKalaJayezeh, int ccKalaCodeJayezeh, int tedadJayezeh, int isJayezehEntekhabi)
        {
            Log.d("jayezeh" , "ccDarkhastFaktor : " + ccDarkhastFaktor + " ,ccForoshandeh:" + ccForoshandeh);
            ...
            if (isJayezehEntekhabi == 0)
            {
                ...
                String NameKala = kalaDAO.getByccKalaCode(ccKalaCodeJayezeh).getNameKala();
                ...
                if (countKalaMojodi <= 0)
                {
                    ...
                    insertTakhfifNaghdi(ccJayezeh, sharhJayezeh, ccKalaJayezeh, tedadJayezeh, tedadJayezeh, ccDarkhastFaktor, ccForoshandeh);
                }
                else if (countKalaMojodi >= tedadJayezeh && countMaxMojody >= tedadJayezeh)
                {
                    ...
                    Log.d("Jayezeh" , "insertJayezeh auto");
                   //todo jayazeh namekala
                ...
                else //if (countMojodiForKala > 0 && countMojodiForKala < tedadJayezeh)
                {
                    ...
                    {
                        insertJayezeh(ccDarkhastFaktor,ccJayezeh,ccJayezehSatr,DarkhastFaktorJayezehModel.CodeNoeJayezehAuto(),NameKala,ccKalaJayezeh,ccKalaCodeJayezeh,countKalaMojodi);
                        insertTakhfifNaghdi(ccJayezeh, sharhJayezeh, ccKalaJayezeh, tedadJayezeh, diff, ccDarkhastFaktor, ccForoshandeh);
                    }
                }
            }
            else
        ...
        private boolean checkKalaForInsertKalaMojodi(int ccKalaJayezeh , int tedadJayezeh)
        {
            ...
            int insertedKala = 0;
            int tedadJayezehCount = tedadJayezeh;
            ...
            for (KalaMojodiModel kala : kalaMojodiModels)
            {
                ...
                Log.d("Jayezeh" , "end FOR insertedKala : " + insertedKala + " , tedadJayezeh : " + tedadJayezeh);
        ...
        private void insertTakhfifNaghdi(int ccJayezeh , String sharhJayezeh , int ccKalaCode , int countAllBonus , int countDiffBonus, long ccDarkhastFaktor, int ccForoshandeh)
        {
            DarkhastFaktorSatrDAO darkhastFaktorSatrDAO = new DarkhastFaktorSatrDAO(mPresenter.getAppContext());
            ...
            if (kalaModel.getCcKalaCode() > 0)
            {
                ...
                darkhastFaktorTakhfifDAO.insert(darkhastFaktorTakhfifModel);
                calculateMablaghVahedTakhfifNaghdiDarkhastFaktorSatr(mablaghMandeh,darkhastFaktorSatrModels);
    ...
    private class AsyncTaskRequestDetail extends AsyncTask<ArrayList<KalaDarkhastFaktorSatrModel> , Void , Integer>
    {
        ...
        double sumMablaghBaArzeshAfzoodehTakhfif = 0;
        ...
        double Mablagh_ArzeshAfzoodehTakhfif_Satr = 0;
        double JamDarsadTakhfifNaghdi = 0;
        double MablaghTakhfifNaghdi = 0;
        double maliat = 0;
        double avarez = 0;
        double maliatTakhfif = 0;
        double avarezTakhfif = 0;
...
//                }
                ...
                for (DarkhastFaktorSatrModel model : darkhastFaktorSatrDAO.getByccDarkhastFaktorAndNotNoeKala(ccDarkhastFaktor , -1, ccForoshandeh))
                {
                    ...
                    double zaribTakhfifArzeshAfzodeh = 0;
                    ...
                    if (model.getTedad3() != 0)
                    {
                        ...
                        Mablagh_ArzeshAfzoodehTakhfif_Satr = 0;
                        ...
                        Mablagh_ArzeshAfzoodehTakhfif_Satr = ((model.getTedad3() * model.getMablaghForosh()) - Takhfif_Satr);
                        Log.d("mablagh" , "Mablagh_ArzeshAfzoodeh_Satr : " + Mablagh_ArzeshAfzoodeh_Satr);
                        Log.d("mablagh" , "Mablagh_ArzeshAfzoodehTakhfif_Satr : " + Mablagh_ArzeshAfzoodehTakhfif_Satr);
                        ...
                        Mablagh_ArzeshAfzoodehTakhfif_Satr = Mablagh_ArzeshAfzoodehTakhfif_Satr - ((model.getMablaghForosh() * MablaghTakhfifNaghdi) / sumMablaghKol) * model.getTedad3();
                        ...
                        Log.d("mablagh" , "2 Mablagh_ArzeshAfzoodehTakhfif_Satr : " + Mablagh_ArzeshAfzoodehTakhfif_Satr + "," + model.getMablaghForosh() + " , " + JamDarsadTakhfifNaghdi + " , " + MablaghTakhfifNaghdi + " , " + sumMablaghKol + " , " + model.getTedad3());
                        maliat = 0;
                        avarez = 0;
                        maliatTakhfif = 0;
                        avarezTakhfif = 0;
                        if (kala.getMashmolMaliatAvarez() == 1 && model.getCodeNoeKala() != 2)
                        {
                            ...
                            darsadMaliat = kala.getDarsadMaliat();
                            darsadAvarez = kala.getDarsadAvarez();
                            zaribTakhfifArzeshAfzodeh = kala.getZaribTakhfifArzeshAfzodeh();
                            ...
                            maliatTakhfif = (Mablagh_ArzeshAfzoodehTakhfif_Satr / model.getTedad3()) * (darsadMaliat * zaribTakhfifArzeshAfzodeh)  / 100;
                            avarezTakhfif = (Mablagh_ArzeshAfzoodehTakhfif_Satr / model.getTedad3()) * (darsadAvarez * zaribTakhfifArzeshAfzodeh) / 100;

                            Mablagh_ArzeshAfzoodeh_Satr += ((maliat + avarez) * model.getTedad3());
                            Log.d("mablagh" , "3 Mablagh_ArzeshAfzoodeh_Satr : " + Mablagh_ArzeshAfzoodeh_Satr  + " ,maliat : " + maliat + " , Avarez : " + avarez );
                            Log.d("mablagh" , "3 Mablagh_ArzeshAfzoodehTakhfif_Satr : " + Mablagh_ArzeshAfzoodehTakhfif_Satr  + " ,maliatTakhfif : " + maliatTakhfif + " , avarezTakhfif : " + avarezTakhfif );
                        }
                        ...
                        if (model.getMablaghForosh() != 1)
                        {
                            ...
                            darkhastFaktorSatrDAO.updateMaliatAvarezTakhfif(model.getCcDarkhastFaktorSatr(), maliatTakhfif, avarezTakhfif);
                        }

                        sumMablaghBaArzeshAfzoodeh += ((maliat + avarez) * model.getTedad3());
                        sumMablaghBaArzeshAfzoodehTakhfif += ((maliatTakhfif + avarezTakhfif) * model.getTedad3());

                        Log.d("mablagh" , "4 sumMablaghBaArzeshAfzoodeh : " + sumMablaghBaArzeshAfzoodeh );
                        Log.d("mablagh" , "4 sumMablaghBaArzeshAfzoodehTakhfif : " + sumMablaghBaArzeshAfzoodehTakhfif );
                        Log.d("mablagh" , "5 Mablagh_ArzeshAfzoodeh_Satr : " + Mablagh_ArzeshAfzoodeh_Satr + " , " + maliat + " , " + avarez);
        ...
        protected void onPostExecute(Integer num)
        {
            if (num == 1)
            {
                ...
                DarkhastFaktorTakhfifDAO darkhastFaktorTakhfifDAO = new DarkhastFaktorTakhfifDAO(mPresenter.getAppContext());
                DarkhastFaktorJayezehDAO darkhastFaktorJayezehDAO = new DarkhastFaktorJayezehDAO(mPresenter.getAppContext());
                Log.d("VerifyRequest","jayezeh sumMablaghBaArzeshAfzoodeh:"+sumMablaghBaArzeshAfzoodeh +" VerifyRequestActivity.SuccessGetBonus: "+ VerifyRequestActivity.SuccessGetBonus);
                int canEditDarkhastForMovaze = Integer.parseInt(new ParameterChildDAO(mPresenter.getAppContext()).getValueByccChildParameter(Constants.CC_CHILD_Can_Edit_Darkhast_For_Movaze()));
                Log.d("VerifyRequest","canEditDarkhastForMovaze:"+canEditDarkhastForMovaze);
                if (!VerifyRequestActivity.SuccessGetBonus && sumMablaghBaArzeshAfzoodeh>0 && canEditDarkhastForMovaze==1)
                {
                    if (darkhastFaktorTakhfifDAO.deleteTakhfifByCodeNoe(ccDarkhastFaktor, DarkhastFaktorJayezehTakhfifModel.NoeArzeshAfzoodeh())) {
                        Log.d("VerifyRequest", "AsyncTaskMohasebehJayezehArzeshAfzoodeh sumMablaghKol:"+ sumMablaghKol + " sumMablaghBaArzeshAfzoodeh:" + sumMablaghBaArzeshAfzoodeh  + " ,sumMablaghBaArzeshAfzoodehTakhfif: "+ sumMablaghBaArzeshAfzoodehTakhfif +" sumTedadAghlam:" + sumTedadAghlam + " tedadAghlam:" + tedadAghlam + " sumHajm:"+ sumHajm + " sumVazn:" + sumVazn + " vaznFaktor:" + vaznFaktor);
                        ...
                        AsyncTaskMohasebehJayezehArzeshAfzoodeh asyncTaskMohasebehJayezehArzeshAfzoodeh = new AsyncTaskMohasebehJayezehArzeshAfzoodeh(sumMablaghKol, sumMablaghBaArzeshAfzoodeh,Math.round(sumMablaghBaArzeshAfzoodehTakhfif), sumTedadAghlam, tedadAghlam, sumHajm, sumVazn, vaznFaktor, hajmFaktor, sumMablaghKhales, sumTedadAghlamPishnehadiBiSetareh);
                ...
                //todo jayazeh
                    int sizeDFJ =  darkhastFaktorJayezehDAO.getCountByccDarkhastFaktorForJayezehArzesh(ccDarkhastFaktor);
                    int sizeDFT =  darkhastFaktorTakhfifDAO.getCountJayezehByccDarkhastFaktorForJayezehArzesh(ccDarkhastFaktor);
                    Log.d("VerifyRequest","jayezeh sizeDFT:"+sizeDFT +" sizeDFJ: "+ sizeDFJ);
    ...
    class AsyncTaskMohasebehJayezehArzeshAfzoodeh extends AsyncTask<Void, Void, Integer>
    {
        ...
        public AsyncTaskMohasebehJayezehArzeshAfzoodeh(long sumMablaghKol, double sumMablaghBaArzeshAfzoodeh, double sumMablaghBaArzeshAfzoodehTakhfif, int sumTedadAghlam, int tedadAghlam, double sumHajm, double sumVazn, double vaznFaktor, double hajmFaktor, double sumMablaghKhales, int sumTedadAghlamPishnehadiBiSetareh) {
            this.sumMablaghKol = sumMablaghKol;
            this.sumMablaghBaArzeshAfzoodeh = sumMablaghBaArzeshAfzoodeh;
            this.sumMablaghBaArzeshAfzoodehTakhfif = sumMablaghBaArzeshAfzoodehTakhfif;
        ...
        protected Integer doInBackground(Void... voids)
        {
            try {
                ...
                if(jayezehModel != null)
                {
                    ...
                    int ccJayezehSatr = 0;
                    ccJayezehSatr = jayezehSatrDAO.getccJayezehSatrForArzeshAfzoodeh(jayezehModel.getCcJayezeh(), sumMablaghBaArzeshAfzoodehTakhfif);
                    ...
                    if(ccJayezehSatr>0){
                        ...
                        model.setMablaghTakhfif((long) sumMablaghBaArzeshAfzoodehTakhfif);
                        model.setExtraProp_ForJayezeh(1);
                        model.setExtraProp_IsTakhfifMazad(0);
                        DarkhastFaktorTakhfifDAO darkhastFaktorTakhfifDAO = new DarkhastFaktorTakhfifDAO(mPresenter.getAppContext());
                        Log.d("JayezehArzeshAfzoodeh","sumMablaghBaArzeshAfzoodehTakhfif:" + sumMablaghBaArzeshAfzoodehTakhfif );
     ...
     private boolean checkCanSelectBonus(){
        ...
        SelectFaktorShared selectFaktorShared = new SelectFaktorShared(mPresenter.getAppContext());
         ...
         if (ccDarkhastFaktor != -1) {
             ...
             ArrayList<Integer> ccTakhfifs = darkhastFaktorTakhfifDAO.getccTakhfifOfJayezehByccDarkhastFaktor(ccDarkhastFaktor);
             String strccTakhfifs = "";
             Log.d("ccTakhfif", "jayezeh size : " + ccTakhfifs.size() + ccTakhfifs.toString());
             if (ccTakhfifs.size() > 0) {
                 canSelectBonus = true;
                 for (int i : ccTakhfifs) {
                     Log.d("ccTakhfif", "jayezeh ccTakhfif : " + i);
                     strccTakhfifs += i + ",";
                 }
                 Log.d("ccTakhfif", "jayezeh  strccTakhfifs for : " + strccTakhfifs);
                 if (strccTakhfifs.length() > 0 && strccTakhfifs.endsWith(",")) {
                     strccTakhfifs = strccTakhfifs.substring(0, strccTakhfifs.length() - 1);
                 }
                 Log.d("ccTakhfif", "jayezeh strccTakhfifs if : " + strccTakhfifs);
             }
             Log.d("ccTakhfif", "jayezeh strccTakhfifs : " + strccTakhfifs);
             selectFaktorShared.putString(selectFaktorShared.getCcTakhfifJayezes(), strccTakhfifs);
         }
