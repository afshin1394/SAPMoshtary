...
public class CalculateHajmiDiscountTaminKonandeh extends DiscountCalculation
{
    ...
    public boolean calculateDiscount(DarkhastFaktorModel darkhastFaktorModel, TakhfifHajmiTitrSatrModel takhfifHajmiTitrSatrModel)
    {
        try
        {
            ...
            ArrayList<DataTableModel> taminKonandehs = darkhastFaktorSatrDAO.getTedadBeTafkikTaminKonandeh(darkhastFaktorModel.getCcDarkhastFaktor(),takhfifHajmiTitrSatrModel.getOlaviat(), takhfifHajmiTitrSatrModel.getNoeGheymat());
            ...
            for (DataTableModel taminKonandeh : taminKonandehs)
            {
                ...
                ArrayList<DataTableModel> brandByccTaminKonandeh = darkhastFaktorSatrDAO.getBrandByccTaminKonandeh(darkhastFaktorModel.getCcDarkhastFaktor(), ccTaminKonandeh, takhfifHajmiTitrSatrModel.getOlaviat(), takhfifHajmiTitrSatrModel.getNoeGheymat());
...
//                                            takhfifHajmiTitrSatrModel.getForJayezeh(), takhfifHajmiTitrSatrModel.getOlaviat());
    ...
    public boolean calculateMantaghe(DarkhastFaktorModel darkhastFaktorModel, TakhfifHajmiTitrSatrModel takhfifHajmiTitrSatrModel, int ccMantaghehMoshtary)
    {
        ...
        // Hasbe TaminKonandeh..
        List<DataTableModel> taminKonandehs = darkhastFaktorSatrDAO.getTedadBeTafkikTaminKonandeh(darkhastFaktorModel.getCcDarkhastFaktor(),takhfifHajmiTitrSatrModel.getOlaviat(), takhfifHajmiTitrSatrModel.getNoeGheymat());
        for (DataTableModel taminKonandeh : taminKonandehs)
        {
            ccTaminKonandeh = Integer.valueOf(taminKonandeh.getFiled1());
            sumTedadTaminKonandeh = Long.valueOf(taminKonandeh.getFiled2());
            ...
            tedadAghlam=Integer.valueOf(taminKonandeh.getFiled7());
            // --------------------------------------------------------------------------
            List<DataTableModel> brandByccTaminKonandeh = darkhastFaktorSatrDAO.getBrandByccTaminKonandeh(darkhastFaktorModel.getCcDarkhastFaktor(), ccTaminKonandeh, takhfifHajmiTitrSatrModel.getOlaviat(), takhfifHajmiTitrSatrModel.getNoeGheymat());
            for (DataTableModel brand : brandByccTaminKonandeh)
            {
