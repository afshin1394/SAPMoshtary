...
public class CalculateHajmiDiscountBrand extends DiscountCalculation
{
    ...
    public boolean calculateDiscount(DarkhastFaktorModel darkhastFaktorModel, TakhfifHajmiTitrSatrModel takhfifHajmiTitrSatrModel)
    {
        try
        {
            ...
            ArrayList<DataTableModel> brands = darkhastFaktorSatrDAO.getTedadBeTafkikBrand(darkhastFaktorModel.getCcDarkhastFaktor(), takhfifHajmiTitrSatrModel.getOlaviat());
            ...
            for (DataTableModel brand : brands)
            {
                ...
                for (TakhfifHajmiSatrModel takhfifHajmiSatrModel : takhfifHajmiSatrs)
                {
                    ...
                    ArrayList<DataTableModel> brandMohasebeh = darkhastFaktorSatrDAO.getTedadBeTafkikBrandMohasebeh(darkhastFaktorModel.getCcDarkhastFaktor(), takhfifHajmiTitrSatrModel.getOlaviat(), ccBrandMohasebeh);
                    ...
                    if (mablaghTakhfif > 0)
                    {
                        ...
                        for (DataTableModel kalaBrand : arrayListKalaBrandInDarkhast)
                        {
                            if (kalaBrand.getFiled1() != null && kalaBrand.getFiled1().trim().equals(String.valueOf(ccBrandMohasebeh)))
                            {
                                ...
                                insertFaktorSatrTakhfifHajmi(context, Long.valueOf(kalaBrand.getFiled2()), codeTakhfif, takhfifHajmiTitrSatrModel.getCcTakhfifHajmi(),
    ...
    public boolean calculateMantaghe(DarkhastFaktorModel darkhastFaktorModel, TakhfifHajmiTitrSatrModel takhfifHajmiTitrSatrModel, int ccMantaghehMoshtary)
    {
        ...
        // Brand..
        List<DataTableModel> brands = new DarkhastFaktorSatrDAO(context).getTedadBeTafkikBrand(darkhastFaktorModel.getCcDarkhastFaktor(), takhfifHajmiTitrSatrModel.getOlaviat());
        for (DataTableModel brand : brands)
        {
            ccBrand = Integer.valueOf(brand.getFiled1());
                    ...
                    if (mablaghTakhfif != 0)
                    {
                        ...
                        for (DarkhastFaktorSatrModel darkhastFaktorSatr : darkhastFaktorSatrs)
                        {
                            ...
                            if (kalaModel.getCcBrand() == ccBrand)
                            {
                                ...
                                insertFaktorSatrTakhfifHajmi(context, darkhastFaktorSatr.getCcDarkhastFaktorSatr(), codeTakhfif,
